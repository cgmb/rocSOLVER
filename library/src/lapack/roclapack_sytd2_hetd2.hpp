...
template <typename T>
ROCBLAS_KERNEL void set_tau(const rocblas_int batch_count, T* tmptau, T* tau, const rocblas_stride strideP)
{
...
ROCBLAS_KERNEL void set_tridiag(const rocblas_fill uplo,
                            const rocblas_int n,
                            U A,
