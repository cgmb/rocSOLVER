...
ROCBLAS_KERNEL void __launch_bounds__(GETF2_MAX_THDS) LUfact_panel_kernel(const rocblas_int m,
                                                                      const rocblas_int n,
                                                                      U AA,
...
ROCBLAS_KERNEL void __launch_bounds__(GETF2_MAX_THDS)
...
************************************************************************/
template <rocblas_int DIM, typename T, typename U>
ROCBLAS_KERNEL void __launch_bounds__(GETF2_MAX_THDS) LUfact_small_kernel(const rocblas_int m,
                                                                      U AA,
                                                                      const rocblas_int shiftA,
                                                                      const rocblas_int lda,
                                                                      const rocblas_stride strideA,
...
template <typename T, typename U>
ROCBLAS_KERNEL void getf2_check_singularity(U AA,
                                        const rocblas_int shiftA,
                                        const rocblas_stride strideA,
                                        rocblas_int* ipivA,
                                        const rocblas_int shiftP,
