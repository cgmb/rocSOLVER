...
ROCBLAS_KERNEL void sygs2_set_diag1(const rocblas_int k,
                                U AA,
...
template <typename T, typename U>
ROCBLAS_KERNEL void sygs2_set_diag2(const rocblas_int k,
                                U AA,
                                const rocblas_int shiftA,
                                const rocblas_int lda,
                                const rocblas_stride strideA,
...
template <typename T, typename U>
ROCBLAS_KERNEL void sygs2_set_diag3(const rocblas_int k,
                                U AA,
                                const rocblas_int shiftA,
                                const rocblas_int lda,
                                const rocblas_stride strideA,
