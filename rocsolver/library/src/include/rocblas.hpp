                                ...
                                T** workArr = nullptr)
{
    ...
    return rocblas_trsm_template<ROCBLAS_TRSM_BLOCK, BATCHED, T>(
        ...
        cast2nonConstPointer(B), offset_B, ldb, stride_B, batch_count, optimal_mem, x_temp,
                                ...
                                T** workArr)
{
    ...
    return rocblas_trsm_template<ROCBLAS_TRSM_BLOCK, BATCHED, T>(
        ...
        stride_A, cast2nonConstPointer(B), offset_B, ldb, stride_B, batch_count, optimal_mem,
                                 ...
                                 T** workArr)
{
    ...
    return rocblas_trtri_template<ROCBLAS_TRTRI_NB, BATCHED, STRIDED, T>(
        handle, uplo, diag, n, cast2constType(A), offset_A, lda, stride_A, 0, workArr, offset_invA,
        ldinvA, stride_invA, 0, batch_count, 1, c_temp_arr);
}
