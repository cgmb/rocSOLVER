                                    ...
                                    rocblas_int* info)
{
    ...
    size_t size_6;
    rocsolver_gesvd_getMemorySize<false, T, TT>(left_svect, right_svect, m, n, batch_count, &size_1,
    ...
    rocblas_status status = rocsolver_gesvd_template<false, false, T>(
        handle, left_svect, right_svect, m, n, A, 0, lda, strideA, S, strideS, U, ldu, strideU, V,
        ldv, strideV, E, strideE, fast_alg, info, batch_count, (T*)scalars, workgral, (T**)workArr,
        (T*)workfunc, (T*)tau, (T*)workTrmm);
