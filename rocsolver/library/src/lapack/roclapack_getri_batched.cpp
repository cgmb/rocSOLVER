                                            ...
                                            const rocblas_int batch_count)
{
    ...
    rocsolver_getri_getMemorySize<true, true, T>(n, batch_count, &size_1, &size_2, &size_3, &size_4,
                                                 &size_5, &size_6);
    ...
    if(!scalars || (size_2 && !work) || (size_3 && !workArr) || (size_4 && !x_temp)
       || (size_5 && !x_temp_arr) || (size_6 && !invA_arr))
    ...
    rocblas_status status = rocsolver_getri_template<true, false, T>(
        ...
        strideP, info, batch_count, (T*)scalars, (T*)work, (T**)workArr, x_temp, x_temp_arr,
        invA_arr, optim_mem);
