                                                    ...
                                                    const rocblas_int batch_count)
{
    ...
    rocsolver_geqrf_getMemorySize<T, false>(m, n, batch_count, &size_1, &size_2, &size_3, &size_4,
                                            &size_5);
    ...
    rocblas_status status = rocsolver_geqrf_template<false, true, T>(
        ...
        lda, strideA, ipiv, stridep, batch_count, (T*)scalars, (T*)work, (T**)workArr, (T*)diag,
        (T*)trfact);
