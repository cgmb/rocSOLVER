                                                ...
                                                const rocblas_int batch_count)
{
    ...
    rocsolver_geqrf_getMemorySize<T, true>(m, n, batch_count, &size_1, &size_2, &size_3, &size_4,
                                           &size_5);
    ...
    rocblas_status status = rocsolver_geqrf_template<true, false, T>(
        ...
        lda, strideA, (T*)ipiv, strideP, batch_count, (T*)scalars, (T*)work, (T**)workArr, (T*)diag,
        (T*)trfact);
