                                                    ...
                                                    const int pivot)
{
    ...
    rocsolver_getrf_getMemorySize<false, T, S>(m, n, batch_count, &size_1, &size_2, &size_3,
                                               &size_4, &size_5, &size_6, &size_7, &size_8, &size_9);
    ...
    if(!scalars || (size_2 && !pivot_val) || (size_3 && !pivot_idx) || (size_4 && !iinfo)
       || (size_5 && !work) || (size_6 && !x_temp) || (size_7 && !x_temp_arr) || (size_8 && !invA)
       || (size_9 && !invA_arr))
    ...
    rocblas_status status = rocsolver_getrf_template<false, true, T, S>(
        ...
        strideP, info, batch_count, pivot, (T*)scalars, (T*)pivot_val, (rocblas_int*)pivot_idx,
        (rocblas_int*)iinfo, (rocblas_index_value_t<S>*)work, x_temp, x_temp_arr, invA, invA_arr,
        optim_mem);
