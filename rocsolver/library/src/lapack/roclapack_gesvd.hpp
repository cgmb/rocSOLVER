                                        ...
                                        T* workTrmm)
{
    ...
    { // (m < THIN_SVD_SWITCH*n && n < THIN_SVD_SWITCH*m)
        ...
        // 1. Bidiagonalize A.
        rocsolver_gebd2_template(handle, m, n, A, shiftA, lda, strideA, S, strideS, E, strideE, tau,
                                 k, (tau + k * batch_count), k, batch_count, scalars, (T*)workgral,
                                 workArr, workfunc);
        ...
        if(leftvS || leftvA)
        {
            ...
            rocsolver_orgbr_ungbr_template<false, STRIDED>(
                ...
                scalars, (T*)workgral, workArr, workfunc, workTrmm);
        }
        ...
        if(rightvO)
        {
            rocsolver_orgbr_ungbr_template<BATCHED, STRIDED>(
                ...
                k, batch_count, scalars, (T*)workgral, workArr, workfunc, workTrmm);
        }
        ...
        if(!leftvO && !rightvO)
        {
            local_bdsqr_template<T>(handle, uplo, k, nv, nu, 0, S, strideS, E, strideE, V, 0, ldv,
                                    strideV, U, 0, ldu, strideU, info, batch_count, (TT*)workgral,
                                    workArr);
        }
