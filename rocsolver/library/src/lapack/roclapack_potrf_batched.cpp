                                            ...
                                            const rocblas_int batch_count)
{
    ...
    rocsolver_potrf_getMemorySize<true, T>(n, uplo, batch_count, &size_1, &size_2, &size_3, &size_4,
                                           &size_5, &size_6, &size_7, &size_8);

    // (TODO) MEMORY SIZE QUERIES AND ALLOCATIONS TO BE DONE WITH ROCBLAS HANDLE
    void *scalars, *work, *pivotGPU, *iinfo, *x_temp, *x_temp_arr, *invA, *invA_arr;
    ...
    if(!scalars || (size_2 && !work) || (size_3 && !pivotGPU) || (size_4 && !iinfo)
       || (size_5 && !x_temp) || (size_6 && !x_temp_arr) || (size_7 && !invA)
       || (size_8 && !invA_arr))
    ...
    rocblas_status status = rocsolver_potrf_template<true, S, T>(
        ...
        lda, strideA, info, batch_count, (T*)scalars, (T*)work, (T*)pivotGPU, (rocblas_int*)iinfo,
