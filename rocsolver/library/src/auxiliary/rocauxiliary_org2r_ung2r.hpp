...
__global__ void init_ident_col(const rocblas_int m,
                               const rocblas_int n,
                               const rocblas_int k,
                               U A,
                                         ...
                                         size_t* size_3)
{
    ...
    rocsolver_larf_getMemorySize<T, BATCHED>(rocblas_side_left, m, n, batch_count, size_1, size_2,
                                             size_3);
}
                                              ...
                                              T** workArr)
{
    ...
    hipLaunchKernelGGL(init_ident_col<T>, dim3(blocksx, blocksy, batch_count), dim3(32, 32), 0,
