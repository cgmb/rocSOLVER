                                          ...
                                          T* ipiv)
{
    ...
    rocsolver_orglq_unglq_getMemorySize<T, false>(m, n, k, batch_count, &size_1, &size_2, &size_3,
                                                  &size_4, &size_5);
    ...
    rocblas_status status = rocsolver_orglq_unglq_template<false, false, T>(
        ...
        lda, strideA, ipiv, strideP, batch_count, (T*)scalars, (T*)work, (T**)workArr, (T*)trfact,
        (T*)workTrmm);
