...
TEST_F(checkin_misc_LOGGING, rocblas_layer_mode_log_trace)
{
    ...
    scoped_envvar logpath_variable("ROCSOLVER_LOG_TRACE_PATH", trace_filepath.generic_string().c_str());
...
TEST_F(checkin_misc_LOGGING, rocblas_layer_mode_log_bench)
{
    ...
    scoped_envvar logpath_variable("ROCSOLVER_LOG_BENCH_PATH", bench_filepath.generic_string().c_str());
...
TEST_F(checkin_misc_LOGGING, rocblas_layer_mode_log_profile)
{
    ...
    scoped_envvar logpath_variable("ROCSOLVER_LOG_PROFILE_PATH", profile_filepath.generic_string().c_str());
